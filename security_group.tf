...
resource "aws_security_group" "loko_alb_security_group" {
  name        = "${var.project_name}-${var.environment}-loko_alb_sg"
...
resource "aws_security_group" "app_server_security_group" {
  ...
  ingress {
    ...
    to_port         = 80
    protocol        = "tcp"
    security_groups = [aws_security_group.loko_alb_security_group.id]
  }
...
resource "aws_security_group" "database_security_group" {
  name        = "${var.project_name}-${var.environment}-loko_db_sg"
